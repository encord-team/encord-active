...
(Background on this error at: https://sqlalche.me/e/14/e3q8)"""
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "annotation_type >= 0 AND annotation_type <= 7", name="prediction_analytics_annotation_type"
        ),
    ...
    op.create_table(
        ...
        sa.Column("metric_custom2", sa.REAL(), nullable=True),
        sa.Column("metric_custom3", sa.REAL(), nullable=True),
        sa.CheckConstraint("annotation_type >= 0 AND annotation_type <= 7", name="project_analytics_annotation"),
    ...
    op.create_table(
        ...
        sa.Column("du_hash", GUID(), nullable=False),
        sa.Column("frame", sa.Integer(), nullable=False),
        sa.Column("data_type", sa.SMALLINT(), nullable=True),
        sa.Column("metric_width", sa.INTEGER(), nullable=True),
        sa.Column("metric_height", sa.INTEGER(), nullable=True),
        sa.Column("metric_area", sa.INTEGER(), nullable=True),
        sa.Column("metric_aspect_ratio", sa.REAL(), nullable=True),
...
def downgrade() -> None:
    ...
    op.drop_index("ix_project_analytics_data_reduced_y", table_name="project_analytics_data_reduced")
    op.drop_index("ix_project_analytics_data_reduced_x", table_name="project_analytics_data_reduced")
    op.drop_table("project_analytics_data_reduced")
    op.drop_table("project_analytics_data_extra")
    op.drop_table("project_analytics_data_derived")
    op.drop_index("ix_project_analytics_annotation_reduced_y", table_name="project_analytics_annotation_reduced")
    op.drop_index("ix_project_analytics_annotation_reduced_x", table_name="project_analytics_annotation_reduced")
    ...
    op.drop_index("ix_project_analytics_data_ph_mtc_random", table_name="project_analytics_data")
    op.drop_index("ix_project_analytics_data_ph_mtc_object_density", table_name="project_analytics_data")
    op.drop_index("ix_project_analytics_data_ph_mtc_object_count", table_name="project_analytics_data")
    op.drop_index("ix_project_analytics_data_ph_mtc_image_uniqueness", table_name="project_analytics_data")
    op.drop_index("ix_project_analytics_data_ph_mtc_image_difficulty", table_name="project_analytics_data")
    op.drop_index("ix_project_analytics_data_ph_mtc_height", table_name="project_analytics_data")
    op.drop_index("ix_project_analytics_data_ph_mtc_green", table_name="project_analytics_data")
    op.drop_index("ix_project_analytics_data_ph_mtc_contrast", table_name="project_analytics_data")
    op.drop_index("ix_project_analytics_data_ph_mtc_brightness", table_name="project_analytics_data")
    op.drop_index("ix_project_analytics_data_ph_mtc_blue", table_name="project_analytics_data")
    op.drop_index("ix_project_analytics_data_ph_mtc_aspect_ratio", table_name="project_analytics_data")
    op.drop_index("ix_project_analytics_data_ph_mtc_area", table_name="project_analytics_data")
    op.drop_table("project_analytics_data")
    op.drop_index("ix_project_analytics_annotation_ph_mtc_width", table_name="project_analytics_annotation")
    op.drop_index("ix_project_analytics_annotation_ph_mtc_sharpness", table_name="project_analytics_annotation")
    op.drop_index("ix_project_analytics_annotation_ph_mtc_shape_outlier", table_name="project_analytics_annotation")
    op.drop_index("ix_project_analytics_annotation_ph_mtc_red", table_name="project_analytics_annotation")
    op.drop_index("ix_project_analytics_annotation_ph_mtc_random", table_name="project_analytics_annotation")
    op.drop_index(
        "ix_project_analytics_annotation_ph_mtc_polygon_similarity", table_name="project_analytics_annotation"
    )
    op.drop_index(
        "ix_project_analytics_annotation_ph_mtc_missing_or_broken_track", table_name="project_analytics_annotation"
    )
    op.drop_index("ix_project_analytics_annotation_ph_mtc_max_iou", table_name="project_analytics_annotation")
    op.drop_index(
        "ix_project_analytics_annotation_ph_mtc_inconsistent_class", table_name="project_analytics_annotation"
    )
    op.drop_index("ix_project_analytics_annotation_ph_mtc_height", table_name="project_analytics_annotation")
    op.drop_index("ix_project_analytics_annotation_ph_mtc_green", table_name="project_analytics_annotation")
    op.drop_index("ix_project_analytics_annotation_ph_mtc_contrast", table_name="project_analytics_annotation")
    op.drop_index("ix_project_analytics_annotation_ph_mtc_confidence", table_name="project_analytics_annotation")
    op.drop_index("ix_project_analytics_annotation_ph_mtc_brightness", table_name="project_analytics_annotation")
    op.drop_index("ix_project_analytics_annotation_ph_mtc_border_relative", table_name="project_analytics_annotation")
    op.drop_index("ix_project_analytics_annotation_ph_mtc_blue", table_name="project_analytics_annotation")
    op.drop_index("ix_project_analytics_annotation_ph_mtc_aspect_ratio", table_name="project_analytics_annotation")
    op.drop_index("ix_project_analytics_annotation_ph_mtc_area_relative", table_name="project_analytics_annotation")
    op.drop_index("ix_project_analytics_annotation_ph_mtc_area", table_name="project_analytics_annotation")
    op.drop_index(
        "ix_project_analytics_annotation_ph_mtc_annotation_quality", table_name="project_analytics_annotation"
    )
    op.drop_table("project_analytics_annotation")
    op.drop_table("prediction_data_units")
    op.drop_index("ix_prediction_analytics_reduced_y", table_name="prediction_analytics_reduced")
    op.drop_index("ix_prediction_analytics_reduced_x", table_name="prediction_analytics_reduced")
    op.drop_table("prediction_analytics_reduced")
    op.drop_table("prediction_analytics_extra")
    op.drop_table("prediction_analytics_derived")
    op.drop_table("project_data_units")
    op.drop_table("prediction_data")
    op.drop_index("ix_prediction_analytics_ph_mtc_width", table_name="prediction_analytics")
    op.drop_index("ix_prediction_analytics_ph_mtc_sharpness", table_name="prediction_analytics")
    op.drop_index("ix_prediction_analytics_ph_mtc_shape_outlier", table_name="prediction_analytics")
    op.drop_index("ix_prediction_analytics_ph_mtc_red", table_name="prediction_analytics")
    op.drop_index("ix_prediction_analytics_ph_mtc_random", table_name="prediction_analytics")
    op.drop_index("ix_prediction_analytics_ph_mtc_polygon_similarity", table_name="prediction_analytics")
    op.drop_index("ix_prediction_analytics_ph_mtc_missing_or_broken_track", table_name="prediction_analytics")
    op.drop_index("ix_prediction_analytics_ph_mtc_max_iou", table_name="prediction_analytics")
    op.drop_index("ix_prediction_analytics_ph_mtc_inconsistent_class", table_name="prediction_analytics")
    op.drop_index("ix_prediction_analytics_ph_mtc_height", table_name="prediction_analytics")
    op.drop_index("ix_prediction_analytics_ph_mtc_green", table_name="prediction_analytics")
    op.drop_index("ix_prediction_analytics_ph_mtc_contrast", table_name="prediction_analytics")
    op.drop_index("ix_prediction_analytics_ph_mtc_confidence", table_name="prediction_analytics")
    op.drop_index("ix_prediction_analytics_ph_mtc_brightness", table_name="prediction_analytics")
    op.drop_index("ix_prediction_analytics_ph_mtc_border_relative", table_name="prediction_analytics")
    op.drop_index("ix_prediction_analytics_ph_mtc_blue", table_name="prediction_analytics")
    op.drop_index("ix_prediction_analytics_ph_mtc_aspect_ratio", table_name="prediction_analytics")
    op.drop_index("ix_prediction_analytics_ph_mtc_area_relative", table_name="prediction_analytics")
    op.drop_index("ix_prediction_analytics_ph_mtc_area", table_name="prediction_analytics")
...
def migrate_sqlite_database_to_new_schema():
        ...
        [
            {
                "project_hash": ph,
                "user_id": user_id,
                "user_email": email if fernet is None else fernet.encrypt(email.encode("utf-8")).decode("utf-8"),
            }
            for (ph, email), user_id in ph_to_user_id_lookup.items()
        ],
    )

    def _transform_analytics_annotation(value: dict) -> None:
    ...
    _sqlite_migrate(
        ...
        "project_analytics_annotation",
        mutate=_transform_analytics_annotation,
        rename={
    ...
    def _migrate_populate_data_type(value: dict) -> None:
        data_type = du_hash_to_data_type_for_analytics[value["du_hash"]]
        value["data_type"] = int(_data_type_migrate_mapping[data_type])
