...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("embedding_clip", sa.LargeBinary(), nullable=True),
        sa.ForeignKeyConstraint(
            ["prediction_hash", "du_hash", "frame"] + _sqlite_hack([], ["object_hash"]),
            [
            ...
            ] + _sqlite_hack([], ["active_project_prediction_analytics.object_hash"]),
    ...
    op.create_table(
        ...
        sa.Column("embedding_hu", sa.LargeBinary(), nullable=True),
        sa.ForeignKeyConstraint(
            ["project_hash", "du_hash", "frame"] + _sqlite_hack([], ["object_hash"]),
            [
            ...
            ] + _sqlite_hack([], ["active_project_analytics_annotation.object_hash"]),
