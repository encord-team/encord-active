...
def select_annotation_analytics(
    ...
    return select(ProjectAnnotationAnalytics).where(
        ...
        ProjectAnnotationAnalytics.annotation_hash == annotation_hash,
    )
...
def select_prediction_analytics_with_extra(
    ...
    return select(ProjectPredictionAnalytics, ProjectPredictionAnalyticsExtra).where(
        ...
        ProjectPredictionAnalytics.annotation_hash == annotation_hash,
        ...
        ProjectPredictionAnalyticsExtra.annotation_hash == annotation_hash,
    )
