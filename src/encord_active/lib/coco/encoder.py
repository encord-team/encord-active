...
class CocoEncoder:
    ...
    def get_image(self, label_hash: str, data_unit: dict) -> dict:
        ...
        * file_name will be also continuous according to all the images that are being extracted from the video.
        ...
        return {
            ...
            "file_name": self.get_file_name_and_download_image(label_hash, data_unit).replace("\\", "/"),
            "height": data_unit["height"],
            "width": data_unit["width"],
    ...
    def get_dicom_image(self, label_hash: str, data_hash: str, height: int, width: int, frame_num: int) -> dict:
        ...
        return {
            ...
            "coco_url": "",
            "id": image_id,
            "file_name": self.get_dicom_file_path(data_hash, frame_num).replace("\\", "/"),
            "height": height,
            "width": width,
            "label_hash": label_hash,
            "data_hash": data_hash,
    ...
    def get_video_image(
        ...
        return {
            ...
            "file_name": self.get_video_file_path(data_hash, frame_num).replace("\\", "/"),
            "height": height,
            "width": width,
            "label_hash": label_hash,
            "data_hash": data_hash,
