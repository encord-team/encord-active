/*
  ...
  - You are about to drop the column `data_link` on the `DataUnit` table. All the data in the column will be lost.
...
INSERT INTO "new_LabelRow" ("created_at", "data_hash", "data_title", "data_type", "id", "label_hash", "label_row_json", "last_edited_at") SELECT "created_at", "data_hash", "data_title", "data_type", "id", "label_hash", "label_row_json", "last_edited_at" FROM "LabelRow";
DROP TABLE "LabelRow";
