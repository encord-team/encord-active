...
from encord_active.lib.common.data_utils import file_path_to_url, download_file
...
def get_data_uri(
    ...
    if local_file.exists():
        raise ValueError(f"uuid collision")
            ...
            with open(local_file, "xb") as file:
                ...
                if r.status_code != 200:
                    raise ConnectionError(
                        f"Something happened, couldn't download file from: {url_or_path}"
                    )
