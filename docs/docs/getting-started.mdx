...
`encord-active` requires [python 3.9][latest-python-3.9-minor-version] or above and [git][git-install] VCS.
...
[colab-download-sandbox-project]: https://colab.research.google.com/drive/11iZE1CCFIGlkWdTmhf5XACDojtGeIRGS?usp=sharing
[colab-import-your-own-project]: https://colab.research.google.com/drive/1zv4i0SH5tyb1KPVsCZfXDwxV72Ip77zS?usp=share_link
