...
If you are an Encord user, you can directly [import](./cli#import-project) your own projects into Encord Active easily.
...
[encord-set-up-public-key-authentication]: https://docs.encord.com/docs/annotate-public-keys#set-up-public-key-authentication
