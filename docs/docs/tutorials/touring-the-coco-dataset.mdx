...
2. `[?] Choose a project:` choose the <span className="text-orange">[open-source][validation]-coco-2017-dataset</span> project by hitting <kbd>enter</kbd>
...
```shell
encord-active visualise /tmp/test1
```
...
<div style={{textAlign: 'center'}}>
  <img src="/img/tutorials/duplicated-annotation-orange.jpeg" alt="Duplicated annotations" width={300} />
...
<div style={{display: "table", borderCollapse: "collapse", width: "100%", margin: "1em"}}>
  <div style={{textAlign: 'center', display: 'table-cell', padding: "5px"}}>
      <img src="/img/tutorials/duplicated-annotation-skiing.jpeg" alt="Duplicated annotations" width={300} style={{display: "block", width: "100%", height: "auto"}} />
  </div>
  <div style={{textAlign: 'center', display: 'table-cell', padding: "5px"}}>
      <img src="/img/tutorials/duplicated-annotation-broccoli.jpeg" alt="Duplicated annotations" width={300} style={{display: "block", width: "100%", height: "auto"}} />
  </div>
  <div style={{textAlign: 'center', display: 'table-cell', padding: "5px"}}>
      <img src="/img/tutorials/duplicated-annotation-fridge.jpeg" alt="Duplicated annotations" width={300} style={{display: "block", width: "100%", height: "auto"}} />
  </div>
</div>
...
<TOCInline toc={getSubsectionNodes(toc, "figuring-out-what-metrics-influence-model-performance")} />
