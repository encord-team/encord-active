...
:::note
This command assumes that you have imported your project using the [COCO importer](../cli#import-project) and that the current working directory is the project folder.
:::
