...
:::note
This command assumes that you have imported you project using the [COCO importer](../cli#project) and that the current working directory is the project folder.
:::
