...
Uploading your data to Encord Annotate is as simple as clicking the _Export to Encord_ button in the toolbox on the explorer pages.
This will create an ontology, a dataset, and a project on Encord Annotate and provide you with links to the three.

:::tip

This requires you to have an ssh-key associated with Encord Active:
