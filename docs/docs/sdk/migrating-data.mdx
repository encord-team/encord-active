...
If the [standard solutions for importing data](../workflows/importing-data-and-labels) do not fit your use-case, your best option is to migrate your data to the [Encord Annotate](https://app.encord.com) before importing it into Encord Active.
