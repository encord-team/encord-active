...
4. **[Optional]** Navigate to the project in Encord Annotate and explore the task modifications in the _Summary_ tab.
   <div style={{display: "flex", justifyContent: "space-between"}}>
     <img src="https://raw.githubusercontent.com/encord-team/encord-active/docs/add-screenshots-in-relabel-feature/docs/docs/images/user-guide/workflow-project-summary.png" width="48%" style={{marginRight: "4%"}} />
     <img src="https://raw.githubusercontent.com/encord-team/encord-active/docs/add-screenshots-in-relabel-feature/docs/docs/images/user-guide/workflow-project-summary-after-relabeling.png" width="48%" />
   </div>
