...
If you prefer to witness an active learning workflow in action please take a look at our end-to-end tutorial about [easy active learning on MNIST][easy-active-learning-in-mnist-tutorial].
