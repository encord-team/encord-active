...
Active learning workflows in the Encord platform are specifically designed for [workflow projects][workflow-project-tutorial].
...
If you prefer to witness an active learning workflow in action, please take a look at the end-to-end tutorial for [MNIST][easy-active-learning-in-mnist-tutorial].
...
If you don't have any projects yet, you can watch the tutorial video on setting up a [workflow project][workflow-project-tutorial-configuring] to get started quickly.
...
## Model training and update {#model-training}

In the active learning workflow, model training plays a crucial role.
It involves training a machine learning model using the initial labeled dataset and iteratively updating it with newly labeled data.
Encord Actives provides support for a wide range of models by allowing you to plug in your own model and interface with it using convenient wrappers.

Check more on this [hands-on section][model-training-in-easy-active-learning-in-mnist-tutorial].
...
[easy-active-learning-in-mnist-tutorial]: ../tutorials/easy-active-learning-on-mnist
[model-training-in-easy-active-learning-in-mnist-tutorial]: ../tutorials/easy-active-learning-on-mnist/#model-training
...
[workflow-project-tutorial]: https://docs.encord.com/docs/annotate-workflows
[workflow-project-tutorial-configuring]: https://docs.encord.com/docs/annotate-workflows#workflows---tutorial
