...
When the unlabeled data is abundant, wouldn’t it be nice if we could pick out the 5% of samples most useful to our model, rather than labeling large swathes of redundant data points?
...
If you already familiar with the active learning foundation, continue your read with an exploration of **Encord Active**'s acquisition functions and common workflows.
